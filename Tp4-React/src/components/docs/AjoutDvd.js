...
export default function RootFunction (){
    ...
    return <Ajoutdvd navigation={navigation}/>
}

const Ajoutdvd = (props) => {
    ...
    function post(e){
        AdminService.postDvd(ajout.titre,ajout.annePub,ajout.auteur,ajout.nbrExemplaires,ajout.duration,ajout.type)
